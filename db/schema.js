...
exports.journalEntries = sqliteTable('journal_entries', {
  ...
  triggerRevenge:   integer('trigger_revenge'),
  triggerSizeUp:    integer('trigger_size_up'),
  triggerFomo:      integer('trigger_fomo'),
  triggerOther:     text('trigger_other'),
  triggerFomoOther:  integer('trigger_fomo_other'),
  triggerFomoActive: integer('trigger_fomo_active'),
