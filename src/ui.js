...
function alertLineOpts(a) {
  return { color: a.triggered ? (isDark() ? '#6B6060' : '#D1BDBD') : getCSSVar('--danger'), lineWidth: 1, lineStyle: 2, axisLabelVisible: true, axisLabelColor: 'rgba(0,0,0,0)', axisLabelTextColor: 'rgba(0,0,0,0)', title: '' };
}
