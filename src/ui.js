...
function _initChartForSym(sym) {
  ...
  lbl.style.cssText = 'position:absolute;pointer-events:none;z-index:6;display:none;white-space:nowrap;font:500 10px/12px Manrope,Arial,sans-serif;';
  el.appendChild(lbl);
...
export function openCoinFullView(sym) {
  ...
  fvLblEl.style.cssText = 'position:absolute;pointer-events:none;z-index:6;display:none;white-space:nowrap;font:500 10px/12px Manrope,Arial,sans-serif;';
